...
<body>
	...
	<div id="photocontent"
		...
		<div id="level" style="text-align: center;margin: 50px auto"><h2>CHOOSE YOUR TEST IN ${level } LEVEL</h2></div>
		<table id="listunittable" style="margin: 0px auto; width: 76%" cellspacing="0" class="table">
						...
						<tbody>
			<c:forEach items="${listShortConversation}" var="shortConversation">
				<tr style="margin-top:0px">
					...
					<div id="information" style="margin-left:35%">
						<div id="unittitle" style="color: green"><h3>${ shortConversation.shortConversationName}</h3></div>
						<div id="unitdescript"><h4>${ shortConversation.shortConversationDescription}</h4></div>
						<a id="starttest" href="doshortconversation?unit=${ shortConversation.shortConversationId}">Start your test!</a>
					</div>
				</td>
				</tr>
			</c:forEach>
				...
				<div class="modal-content">
					<div class="modal-body">
						<div class="container" style="width: 100%">
							<form method="post" action="uploadshortconversation" enctype="multipart/form-data">
